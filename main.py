...
from utils.dataset import DocDataset, ModelIterDataset, BatchGenerator
...
if __name__ == '__main__':
    ...
    model_iter_dataset = ModelIterDataset(doc_dataset)

    net = WCSubnet()
    #validator = Validator(model=net, dataset=model_iter_dataset)
